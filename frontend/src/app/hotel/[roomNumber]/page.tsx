...
export default function GuestChatPage() {
  ...
  // Remove manual ticket creation function since tickets are now automatic
        ...
        {showGuestForm ? (
          <Card className="max-w-md mx-auto">
            <CardHeader className="text-center pb-2">
              ...
              <CardTitle className="text-xl">Welcome to Room {roomNumber}</CardTitle>
  ...
  <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg">Ella - AI Chatbot</CardTitle>
            ...
            <div className="border-b" />
            <CardContent className="p-0 flex-1 overflow-scroll">
                  ...
                  {messages.length === 0 ? (
                    <div className="flex items-center justify-center h-64 text-muted-foreground">
                      <div className="text-center">
                        ...
                        <p className="text-sm">Ella chatbot is ready to help</p>
                      </div>
                    </div>
                  ) : (
                    messages.map((msg, index) => (
                      ...
                      >
                        ...
                        >
                          ...
                          <p className="whitespace-pre-wrap break-words text-sm overflow-wrap-anywhere word-break-break-word">{msg.content}</p>
                        </div>
                        {msg.role === 'user' && (
                          <Avatar className="h-8 w-8 mt-1">
                            <AvatarFallback className="bg-primary/10">
          ...
          <div className="flex gap-3 justify-start">
                      ...
                      <div className="bg-muted rounded-lg px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">Ella is thinking...</span>
                        </div>
                      </div>
                    </div>
                  )}
        ...
        {/* Prompt input outside and below the chat card */}
        {!showGuestForm && (
          <Card className="mt-4">
        ...
        {/* No ticket dialog needed - tickets are created automatically */}
      </div>
    </div>
  );
}
